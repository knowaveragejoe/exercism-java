...
public class RemoteControlCarTest {
    ...
    public void rankManyCars() {
        ...
        System.out.println(rankings.get(2).getNumberOfVictories());
        System.out.println(rankings.get(3).getNumberOfVictories());
        System.out.println(rankings.get(4).getNumberOfVictories());
        System.out.println(rankings.get(5).getNumberOfVictories());
